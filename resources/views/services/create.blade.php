        ...
        <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12" style="margin-bottom: 15px;">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" style="height:170px" name="description" placeholder="Description"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12" style="margin-bottom: 15px;">
                    ...
                    <input type="number" class="form-control" id="availabilityTarget" name="availability" placeholder="Availability Target">
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12" style="margin-bottom: 15px;">
                    <div class="form-group">
                        <strong>Cost:</strong>
